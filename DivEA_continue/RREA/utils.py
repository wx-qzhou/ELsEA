...
def load_data(data_dir):
    ...
    if raw_train_len < 500:
        ...
        try:
            train_pair += visual_pivot_induction_mini_batch(torch.FloatTensor(embed), left_idx, right_idx, surface=False, ugraph=True, search_batch_sz=50000, index_batch_sz=500000)[0]
        except:
            pass
