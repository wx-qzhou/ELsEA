...
def get_parser():
    ...
    ## data, output
    parser.add_argument('--kgids', type=str, default="zh,en", help="separate two ids with comma. e.g. `fr,en`")
    parser.add_argument('--data_name', type=str, default="dbp15k", required=False, help="input dataset name")
