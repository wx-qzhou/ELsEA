...
def get_parser():
    ...
    ## data, output
    parser.add_argument('--kgids', type=str, default="dbp,yg", help="separate two ids with comma. e.g. `fr,en`")
    parser.add_argument('--data_name', type=str, default="dwy100k", required=False, help="input dataset name")
    ...
    # subtask
    parser.add_argument('--subtask_num', type=int, default=10, required=False)
    ...
    # ea model
    parser.add_argument('--ea_model', type=str, default="dualamn", choices=["rrea", "dualamn", "gcn-align", "lightea"], help="EA model")
