...
if __name__ == "__main__":
    ...
    for epoch in range(FLAGS.max_train_epoch):
        if epoch % 10 == 0:
            neg_left = np.random.choice(e, t * k)
...
# python /public/home/qzhou0/qzhou20194227007/Larger_EA/Baselines/DivEA-main/DivEA/divea/../GCN_Align/run.py --data_dir=../data/DBP15K/zh_en/partition_1 --output_dir=../results/DivEA/DBP15K/zh_en/partition_1 --max_train_epoch=50 --tf_gpu_no=0
    
# python run.py --data_dir=../../data/dbp15k/zh_en/partition_1 --output_dir=../../results/DivEA/gcn-align/dbp15k/zh_en/ --max_train_epoch=50 --tf_gpu_no=0