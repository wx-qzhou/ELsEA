...
class LightEAModule(NeuralEAModule):
    def __init__(self, conf: Config):
        super(LightEAModule, self).__init__(conf)
    ...
    def train_model(self):
        ...
        script_fn = os.path.join(cur_dir, "../LightEA/LightEA_run.py")
        ...
        if ret.returncode != 0:
            raise Exception("DualA did not run successfully.")
